...
channel_for_data  = UnreliableChannel(env=env,Pc=0.1,Pl=0,delay=2,name="DATA_CHANNEL")
channel_for_ack	  = UnreliableChannel(env=env,Pc=0.3,Pl=0,delay=2,name="ACK_CHANNEL")
