...
channel_for_data  = UnreliableChannel(env=env,Pc=0,Pl=0.2,delay=random.choice([2,10,20,5,25]),name="DATA_CHANNEL")
channel_for_ack	  = UnreliableChannel(env=env,Pc=0,Pl=0.2,delay=random.choice([2,10,20,5,25]),name="ACK_CHANNEL")
